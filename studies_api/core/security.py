...
def create_access_token(data: Dict) -> str:
    ...
    # Especificando que o que quero criptografar é o to_encode,
    #  passo a senha que quero criptografar
...
# Quando a requisição chamar essa função, ele vai procurar pelo Bearer Token,
#  se não existir, ele já vai retornar erro
